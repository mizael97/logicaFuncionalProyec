		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<h1>Contactos de personal </h1>

					<a href="ucreate_user.php" class="btn btn-success">Insertar registro</a>
					<a  href="proveedor.php" class="btn btn-success">Proveedores</a></div></li> 
...
die();
								...
								$sql_total_rows = "SELECT * FROM personas";
								...
								$sql = "SELECT * FROM personas ORDER BY nombre LIMIT $start_row, $rows_page";
								...
								<tr>
								 <td>	<div class="c"><?php echo $row["nombre"]; ?></div></td>
									...
									<td>
										<a href="uread_user.php?id=<?php echo $row["id"]; ?>" class="btn btn-default">Leer datos</a>
										<a href="update_user.php?id=<?php echo $row["id"]; ?>" class="btn btn-default">Actualizar</a>
										<a href="udelete_user.php?id=<?php echo $row["id"]; ?>" class="btn btn-default">Borrar</a>
									</td>
								</tr>
