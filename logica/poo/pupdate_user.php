		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form action="pupdate_user.php" method="POST" role="form">
						...
						<div class="form-group">
							...
							<input type="text" name="email" class="form-control" placeholder="Correo..." value="<?php echo empty($email) ? '' : $email; ?>">
							<?php
					...
					<div class="form-group">
							...
							<input type="text" name="phoneone" class="form-control" placeholder="Telefono 2..." value="<?php echo empty($phoneone) ? '' : $phoneone; ?>">
							<?php
						...
						<button type="submit" name="update_submit" class="btn btn-primary">Actualizar usuario</button>

						<a href="proveedor.php" class="btn btn-default">Atras</a>
