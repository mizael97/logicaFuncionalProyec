		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form action="udelete_user.php" method="POST" role="form">
						...
						<button type="submit" name="udelete_user" class="btn btn-primary">Si</button>
						
						<a href="usuario.php" class="btn btn-default">No</a>
